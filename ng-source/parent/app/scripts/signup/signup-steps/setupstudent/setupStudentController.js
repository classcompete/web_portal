...
var SetupStudentCtrl = function($location, Security, grades, SetupStudentValidation, NotificationService, StudentsFactory, $q){
    ...
    this.$q = $q;
    this.students = [];
    this.defStudent = {rb:1,firstName:'',lastName:'',birthday:'',grade:'',email:'',username:'',password:'',retypePassword:'',gender:''};
...
SetupStudentCtrl.prototype.addStudent = function(){
    this.countStudents ++;
    this.students.push({rb:this.countStudents,firstName:'',lastName:'',birthday:'',grade:'',email:'',username:'',password:'',retypePassword:'',gender:''});
};

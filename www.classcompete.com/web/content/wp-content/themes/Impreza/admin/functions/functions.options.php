...
$of_options[] = array( 	"name" 		=> "Logo",
	"desc" 		=> "Recommended size is 240px of height (also for retina displays)",
	"id" 		=> "custom_logo",
	"std" 		=> "",
	"type" 		=> "upload"
	);
...
$of_options[] = array( "name" => "Logo Height in sticky Header",
    "desc" => "Enter value from 20 to 60 (px)",
...
$of_options[] = array( "name" => "Comments at Pages",
    "desc" => "Show Comments at regular Pages",
    "id" => "page_comments",
    "std" => 0,
    "type" => "switch");

$of_options[] = array( "name" => "Comments at Portfolio",
    "desc" => "Show Comments at Portfolio projects",
...
$of_options[] = array( "name" => "Predefined Color Styles",
	"desc" => "",
	"id" => "color_scheme",
...
$of_options[] = array( "name" => "Body Background Size",
    "desc" => "Stretch Body Background Image to actual screen size",
...
$of_options[] = array( "name" => "Header Type",
	"desc" => "Select header type of layout",
	"id" => "main_header_layout",
    "std" => "Default",
    "type" => "select",
    "options" => array(
        'STANDARD (logo and menu in one row)' => 'STANDARD (logo and menu in one row)',
        'STANDARD + TOP (contacts, socials, lang)' => 'STANDARD + TOP (contacts, socials, lang)',
        'ADVANCED (menu below logo)' => 'ADVANCED (menu below logo)',
    ));
...
$of_options[] = array( "name" => "Header Xing",
	"desc" => "",
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Main Menu</strong> font size",
	"id" => "nav_fontsize",
	"std" => "16",
	"type" => "text");
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Regular Text</strong> font size",
	"id" => "regular_fontsize",
	"std" => "14",
	"type" => "text");
	
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Regular Text</strong> line height",
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Heading 1</strong> line height",
	"id" => "h1_lineheight",
	"std" => "48",
	"type" => "text");
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Heading 2</strong> line height",
	"id" => "h2_lineheight",
	"std" => "42",
	"type" => "text");
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Heading 3</strong> line height",
	"id" => "h3_lineheight",
	"std" => "36",
	"type" => "text");
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Heading 4</strong> line height",
	"id" => "h4_lineheight",
	"std" => "32",
	"type" => "text");
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Heading 5</strong> line height",
	"id" => "h5_lineheight",
	"std" => "30",
	"type" => "text");
...
$of_options[] = array( "name" =>  "",
	"desc" => "<strong>Heading 6</strong> line height",
	"id" => "h6_lineheight",
	"std" => "26",
	"type" => "text");

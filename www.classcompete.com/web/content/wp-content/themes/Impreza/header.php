...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-K47W33"
                  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
        '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    })(window,document,'script','dataLayer','GTM-K47W33');</script>
...
if (@$smof_data['main_header_layout'] == 'STANDARD + TOP (contacts, socials, lang)') {
	$extended_header_class = ' headertype_extended';
} elseif (@$smof_data['main_header_layout'] == 'ADVANCED (menu below logo)') {
...
<div class="l-canvas <?php echo $layout_class.' '.$sidebar_position_class.$extended_header_class.$header_position_class; ?>">
	...
	<div class="l-header type_fixed">
		...
		<div class="l-subheader at_top">
			...
			<?php if (@$smof_data['main_header_layout'] == 'STANDARD + TOP (contacts, socials, lang)') { ?>
		...
		<div class="l-subheader at_middle">
			<div class="l-subheader-h i-widgets i-cf">
				...
				<?php if (@$smof_data['main_header_layout'] == 'ADVANCED (menu below logo)') { ?>
					<?php
					$socials = array (
						'email' => 'Email',
						'facebook' => 'Facebook',

...
abstract class REST_Controller extends MY_Controller
{
    ...
    public function setCollection($name, $collection, $page = 1, $max = 1, $count = null)
    {
        ...
        $this->setParam($name . '_collection', $collection);
        $this->setParam($name . '_page', $page);
        $this->setParam($name . '_max', $max);
        $this->setParam($name . '_count', $count);
    }
    ...
    public function transmit()
    {
        if ($this->is_error === true) {
            ...
            $response = array_merge(array('status' => 'success'), $this->params);

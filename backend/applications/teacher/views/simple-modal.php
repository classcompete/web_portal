...
<section aria-hidden="false" aria-labelledby="modal-label-2" role="dialog" tabindex="-1" id="modal-embed" class="semantic-content modal--show is-active">
    ...
    <div class="modal-inner">
        ...
        <footer>
            <button class="btn btn-small btn-info" id="close-video"
                style="font-size: 30px; font-weight: bold; height: auto; padding: 10px;">
                Close Video
            </button>
        </footer>
    </div>
    ...
    <a data-close="Close" title="Close this modal" class="modal-close" href="#!">×</a>
</section>

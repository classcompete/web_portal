...
$config = array(
    ...
    'question_type_10' => array(
        array(
            'field' => 'question_type_10_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
        ),
        array(
            'field' => 'question_type_10_answer[1]',
            'label' => 'Answer 1',
            'rules' => 'required|trim|max_length[50]'
        ),
        array(
            'field' => 'question_type_10_answer[2]',
            'label' => 'Answer 2',
            'rules' => 'required|trim|max_length[50]'
        ),
        array(
            'field' => 'question_type_10_correct',
            'label' => 'Correct',
            'rules' => 'required|trim'
        ),
        array(
            'field' => 'question_type_10_image',
            'label' => 'Image',
            'rules' => 'required|trim'
        )
    ),
    'question_type_10_edit' => array(
        array(
            'field' => 'question_type_10_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
    ...
    'question_type_11' => array(
        array(
            'field' => 'question_type_11_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
        ),
        array(
            'field' => 'question_type_11_question_image',
            'label' => 'Question image',
            'rules' => 'required|trim'
        ),
        array(
            'field' => 'question_type_11_correct',
            'label' => 'Correct',
            'rules' => 'required|trim'
        ),
        array(
            'field' => 'question_type_11_answer_image[1]',
            'label' => 'Answer image 1',
            'rules' => 'required|trim'
        ),
        array(
            'field' => 'question_type_11_answer_image[2]',
            'label' => 'Answer image 2',
            'rules' => 'required|trim'
        ),
    ),
    'question_type_11_edit' => array(
        array(
            'field' => 'question_type_11_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
    ...
    'question_type_12' => array(
        array(
            'field' => 'question_type_12_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
        ),
        array(
            'field' => 'question_type_12_correct',
            'label' => 'Correct',
            'rules' => 'required|trim'
        ),
        array(
            'field' => 'question_type_12_image[1]',
            'label' => 'Image 1',
            'rules' => 'required|trim'
        ),
        array(
            'field' => 'question_type_12_image[2]',
            'label' => 'Image 2',
            'rules' => 'required|trim'
        ),
    ),
    'question_type_12_edit' => array(
        array(
            'field' => 'question_type_12_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
    ...
    'question_type_13' =>array(
        array(
            'field' => 'question_type_13_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
        ),
        array(
            'field' => 'question_type_13_answer[1]',
            'label' => 'Answer 1',
            'rules' => 'required|trim|max_length[99]'
        ),
        array(
            'field' => 'question_type_13_answer[2]',
            'label' => 'Answer 2',
            'rules' => 'required|trim|max_length[99]'
        ),
        array(
            'field' => 'question_type_13_correct',
            'label' => 'Correct',
            'rules' => 'required|trim'
        )
    ),
    'question_type_14' => array(
        array(
            'field' => 'question_type_14_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[150]'
        ),
        array(
            'field' => 'question_type_14_answer[1]',
            'label' => 'Answer 1',
            'rules' => 'required|trim|max_length[131]'
        ),
        array(
            'field' => 'question_type_14_answer[2]',
            'label' => 'Answer 2',
            'rules' => 'required|trim|max_length[131]'
        ),
        array(
            'field' => 'question_type_14_answer[3]',
            'label' => 'Answer 3',
            'rules' => 'required|trim|max_length[131]'
        ),
        array(
            'field' => 'question_type_14_answer[4]',
            'label' => 'Answer 4',
            'rules' => 'required|trim|max_length[131]'
        ),
        array(
            'field' => 'question_type_14_correct',
            'label' => 'Correct',
            'rules' => 'required|trim'
        )
    ),
    'question_type_15' => array(
        array(
            'field' => 'question_type_15_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[76]'
        ),
        array(
            'field' => 'question_type_15_answer[1]',
            'label' => 'Answer 1',
            'rules' => 'required|trim|max_length[86]'
        ),
        array(
            'field' => 'question_type_15_answer[2]',
            'label' => 'Answer 2',
            'rules' => 'required|trim|max_length[86]'
        ),
        array(
            'field' => 'question_type_15_answer[3]',
            'label' => 'Answer 3',
            'rules' => 'required|trim|max_length[86]'
        ),
        array(
            'field' => 'question_type_15_answer[4]',
            'label' => 'Answer 4',
            'rules' => 'required|trim|max_length[86]'
        ),
        array(
            'field' => 'question_type_15_correct_text',
            'field' => 'question_type_15_correct_text',
            'label' => 'Correct',
            'rules' => 'required|trim'
        )
    ),
    'question_type_15_edit' => array(
        array(
            'field' => 'question_type_15_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[73]'
        ),
        array(
            'field' => 'question_type_15_correct_text',
            'label' => 'Correct',
    ...
    'question_type_16' => array(
        array(
            'field' => 'question_type_16_question',
            'label' => 'Question',
            'rules' => 'required|trim|max_length[145]'
        ),
        array(
            'field' => 'question_type_16_answer',
            'label' => 'Answer',
            'rules' => 'required|trim|max_length[100]'
        ),
        array(
            'field' => 'question_type_16_read_text',
            'label' => 'Reading text',
            'rules' => 'required|trim|max_length[469]'
        )
    ),

...
class Teacher_model extends CI_Model{
    ...
    public function save($data, $id){
        ...
        if (empty($id) === true) {
            ...
            if(isset($data->auth_code) === true && empty($data->auth_code) === false){
                $teacher->setAuthCode($data->auth_code);
            }
            $teacher->save();
    ...
    public function get_teacher_image($user_id){
        $img = PropTeacherQuery::create()->findOneByUserId($user_id);
        if($img != null){
    ...
    public function get_teacher_info_by_auth_code($auth_code){
        return PropTeacherQuery::create()->findOneByAuthCode($auth_code);
    }
    ...
    public function get_teacher_name_by_user_id($user_id){

...
class Mailerlib
{
    ...
    public function sendAccountCreated($data)
    {
        ...
        $message = $this->_ci->load->view('mailer/ccomp/parent_account-created', $data, true);
        $this->initialize();
        // Send email
    ...
    public function sendSupportComment($data){
        $subject = 'SUPPORT';
        $message = $this->_ci->load->view('mailer/ccomp/parent_support',$data, true);
        $this->initialize();
    ...
    public function sendCredentialsRecovery($data)
    {
        $subject = 'Your Password Resent';
        $message = $this->_ci->load->view('mailer/ccomp/parent_forgot-credentials', $data, true);

    ...
    <div class="left-sidebar no-margin">
        <div class="widget">
            ...
            <div class="widget-header">
                <div class="title">Students [ <?php echo $count_students?> ]</div>
                <span class="tools">
                    <a style="color:black" class="btn btn-small" href="#"
                       data-original-title="" data-target="#addEditUser" data-backdrop="static"
                       data-toggle="modal" id="addNewStudent">Add New Student</a>
                    <a style="color:black" class="btn btn-small" href="<?php echo site_url('users/students_export')?>"
                        >Export Students</a>
                </span>
            </div>

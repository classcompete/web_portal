    ...
    <div class="form_holder form_edit_bg">
        <div class="question_form_holder form_7 clearfix">
            <div id="question_type_7_question_preview" class="question question_styles">
                <textarea id="question_type_7_question_edit" name="question_type_7_question" placeholder="Enter your question here" maxlength="70"></textarea>
            </div>
            <div id="question_type_7_answer_preview" class="answer answer_styles_preview">
                <div class="controls">
                    <input type="text" id="question_type_7_answer_edit" name="question_type_7_answer" maxlength="9"/>
                </div>
            </div>
            <div id="question_type_7_answer_preview_ok" class="answer answer_ok">ok</div>

            <div id="question_type_7_answer_preview" class="answer answer_styles a1">1</div>

    ...
    <div class="form_holder">
        <div class="question_form_holder form_8 clearfix">
            <div id="question_type_8_question_preview" class="question question_styles">
                <textarea id="question_type_8_question" name="question_type_8_question" placeholder="Enter your question here" maxlength="70"></textarea>
            </div>
            <div id="question_type_8_question_preview_image" class="question_image question_image_style pic1">
                <div id="question_type_8_image" class="image_holder_8_question">
                    ...
                    <input type="hidden" id="question_type_8_image_name" class="image_name" name="question_type_8_question_image"/>
            ...
            <div id="question_type_8_answer_preview" class="answer answer_styles a1">1</div>

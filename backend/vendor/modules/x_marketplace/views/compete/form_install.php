<?php echo form_open_multipart('marketplace/install', array('method' => 'post', 'class' => 'form-horizontal no-margin',
    ...
    <div class="modal-footer">
        <button class="btn btn-success" id="challenge_btn_install">Add to class</button>

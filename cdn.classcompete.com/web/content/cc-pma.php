...
$db['hostname'] = 'mysql51-002.wc2.dfw1.stabletransit.com';
$db['username'] = '727277_cha11ega';
$db['password'] = 'FR825HWe82jWLJl';
$db['database'] = '727277_cclass600859';
 ...
 'pwd'=>$db['password'], #required
 'db'=>$db['database'],  #optional, default DB
 'host'=>$db['hostname'],#optional
 'port'=>"",#optional

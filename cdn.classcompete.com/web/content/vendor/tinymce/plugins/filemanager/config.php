...
$mcFileManagerConfig['general.plugins'] = '';
...
$mcFileManagerConfig['preview.urlprefix'] = 'http://' . $_SERVER['SERVER_NAME'] . '/'; // domain name
...
$mcFileManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'] . '/files'; // absolute or relative from this script path.
$mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] . '/files'; // absolute or relative from this script path.

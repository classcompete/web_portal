...
app.run(['$rootScope','$location','$http','ipCookie','LoginResource',function($rootScope, $location, $http, ipCookie, LoginResource){
    ...
    $rootScope.images_url   = "http://images.classcompete.com/images/";
    $rootScope.images_upload_url = "http://images.classcompete.com/upload/";
    $rootScope.teacher_image_upload = "http://images.classcompete.com/teacher_image";
    $rootScope.question_image = "http://images.classcompete.com/question_image";
    $rootScope.choice_image = "http://images.classcompete.com/question_choice_image";
    $rootScope.image_maker = "http://images.classcompete.com/image_maker";

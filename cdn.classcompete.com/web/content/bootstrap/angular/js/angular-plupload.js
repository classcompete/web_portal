...
angular.module('plupload.module', [])
    .directive('plUpload', ['ipCookie',function (ipCookie) {
        return {
            restrict: 'A',
            scope: {
                'plProgressModel': '=',
            ...
            link: function (scope, iElement, iAttrs) {
                ...
                if(!iAttrs.plFlashSwfUrl){
                    iAttrs.$set('plFlashSwfUrl','lib/plupload-2.0.0/plupload.flash.swf');
                }
                if(!iAttrs.plSilverlightXapUrl){
                    iAttrs.$set('plSilverlightXapUrl','lib/plupload-2.0.0/plupload.flash.silverlight.xap');
                }
                ...
                var options = {
                    ...
                    headers:{'X-API-KEY':ipCookie('classcompete')}
                };
                ...
                uploader.bind('FileUploaded', function(up, file, res) {
                    if(iAttrs.uploadedImage){
                        scope.uploadedImage.push(res);
                    }
                ...
                uploader.bind('UploadProgress',function(up,file){
                    ...
                    $('#upload_image_percent').css('width',file.percent+'%');

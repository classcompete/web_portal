...
app.run(['$rootScope','$location','$http','ipCookie','LoginResource',function($rootScope, $location, $http, ipCookie, LoginResource){
    ...
    $rootScope.$on( "$routeChangeStart", function(event, next, current) {
        ...
        }else if(next.templateUrl === 'partials/basic_reports.html' || next.templateUrl === 'partials/statistic_reports.html'){
            $rootScope.subNavReports = true;
        }
    });

    $rootScope.images_url   = "http://images.classcompete.local/images/";
    $rootScope.images_upload_url = "http://images.classcompete.local/upload/";
    $rootScope.teacher_image_upload = "http://images.classcompete.local/teacher_image";
    $rootScope.question_image = "http://images.classcompete.local/question_image";
    $rootScope.choice_image = "http://images.classcompete.local/question_choice_image";
    $rootScope.image_maker = "http://images.classcompete.local/image_maker";
